...
int main() {
    ...
    Deliveryman deliveryman1("João Fofuxo", "Rua 1", 10, "Car", 1000);
    ...
    Client client1("João das Neves", "Rua 1", 1);
    ...
    Edge edge23("Rua Praia de Botafogo", &deliveryman3, &vertex3, 1000, 1100);
    Edge edge24("Rua Praia de Botafogo", &vertex3, &vertex4, 1100, 1200);
    Edge edge25("Rua Praia de Botafogo", &vertex4, &seller1, 1200, 2000);
    ...
    graph.addStreet(&edge23);
    graph.addStreet(&edge24);
    graph.addStreet(&edge25);

    Request request(client1, seller1, product, 1);

    vector<Vertex*> deliverymen = operation1(graph, 3, request);

    // get the deliveryman with the shortest path
    Vertex* deliveryman = deliverymen[2];

    vector<Vertex*> path = operation2(graph, *deliveryman, request);
